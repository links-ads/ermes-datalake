...
class notifyPlugin(SingletonPlugin):
    ...
    def __init__(self, name=None):
        ...
        self.parameters = pika.ConnectionParameters(host=self.hostname, virtual_host=self.vhost, credentials=self.credentials, port=self.port, ssl_options=self.ssl_options)
