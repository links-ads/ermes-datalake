...
def get_commands():
    return [spatial, spatial_validation]


@click.group("spatial-validation", short_help="Validation commands")
...
@click.group(short_help="Performs spatially related operations.")
def spatial():
    pass
