...
class TestAction(SpatialTestBase):
    ...
    def test_spatial_query(self):
        dataset = factories.Dataset(extras=[{"key": "spatial", "value": self.geojson_examples["point"]}])

        result = helpers.call_action("package_search", extras={"ext_bbox": "-180,-90,180,90"})
    ...
    def test_spatial_query_outside_bbox(self):
        ...
        factories.Dataset(extras=[{"key": "spatial", "value": self.geojson_examples["point"]}])

        result = helpers.call_action("package_search", extras={"ext_bbox": "-10,-20,10,20"})
    ...
    def test_spatial_query_nz(self):
        ...
        result = helpers.call_action("package_search", extras={"ext_bbox": "56,-54,189,-28"})
    ...
    def test_spatial_query_nz_wrap(self):
        dataset = factories.Dataset(extras=[{"key": "spatial", "value": extents["nz"]}])
        result = helpers.call_action("package_search", extras={"ext_bbox": "-203,-54,-167,-28"})
    ...
    def test_spatial_query_ohio(self):
        ...
        dataset = factories.Dataset(extras=[{"key": "spatial", "value": extents["ohio"]}])

        result = helpers.call_action("package_search", extras={"ext_bbox": "-110,37,-78,53"})
    ...
    def test_spatial_query_ohio_wrap(self):
        ...
        result = helpers.call_action("package_search", extras={"ext_bbox": "258,37,281,51"})
    ...
    def test_spatial_query_dateline_1(self):
        ...
        dataset = factories.Dataset(extras=[{"key": "spatial", "value": extents["dateline"]}])

        result = helpers.call_action("package_search", extras={"ext_bbox": "-197,56,-128,70"})
    ...
    def test_spatial_query_dateline_2(self):
        ...
        result = helpers.call_action("package_search", extras={"ext_bbox": "162,54,237,70"})
    ...
    def test_spatial_query_dateline_3(self):
        ...
        dataset = factories.Dataset(extras=[{"key": "spatial", "value": extents["dateline2"]}])
...
class TestHarvestedMetadataAPI(SpatialTestBase):
    def test_api(self, app):
        ...
        hoe = HarvestObjectExtra(key="original_document", value=original_content2, object=ho2)
