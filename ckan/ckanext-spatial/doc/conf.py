...
latex_documents = [
    ("index", "ckanext-spatial.tex", "ckanext-spatial Documentation", "Open Knowledge Foundation", "manual"),
]
...
man_pages = [("index", "ckanext-spatial", "ckanext-spatial Documentation", ["Open Knowledge Foundation"], 1)]
