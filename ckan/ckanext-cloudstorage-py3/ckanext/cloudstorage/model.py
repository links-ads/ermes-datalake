...
from sqlalchemy import Column, UnicodeText, DateTime, ForeignKey, Integer, Numeric
...
class MultipartPart(Base, DomainObject):
    ...
    upload_id = Column(UnicodeText, ForeignKey("cloudstorage_multipart_upload.id"), primary_key=True)
    upload = relationship(
