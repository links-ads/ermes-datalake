...
class themeGroupForm(SingletonPlugin):
    ...
    def update_config(self, config):
        ...
        template_dir = os.path.join(rootdir, "ckanext", "theme", "theme", "templates")
...
class themeDatasetForm(SingletonPlugin, ckan.lib.plugins.DefaultDatasetForm):
    ...
    def setup_template_variables(self, context, data_dict=None):
        ...
        c.publishers = [("theme publisher", "theme publisher 2")]
