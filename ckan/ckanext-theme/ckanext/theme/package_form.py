...
# Setup the fieldset
def build_theme_form(is_admin=False, user_editable_groups=None, **kwargs):
...
def get_theme_fieldset(is_admin=False, user_editable_groups=None, **kwargs):
    return build_theme_form(is_admin=is_admin, user_editable_groups=user_editable_groups, **kwargs).get_fieldset()
