...
# Setup the fieldset
def build_authcheck_form(is_admin=False, user_editable_groups=None, **kwargs):
    ...
    field_groups = OrderedDict(
        [
            (_("Customised Basic information"), ["title", "name", "url", "notes", "tags"]),
            (
                _("Details"),
                [
                    "author",
...
def get_authcheck_fieldset(is_admin=False, user_editable_groups=None, **kwargs):
    return build_authcheck_form(is_admin=is_admin, user_editable_groups=user_editable_groups, **kwargs).get_fieldset()
